 ...
 */
suspend fun DiscordClient.getGuildBan(guildId: String, userId: String): DiscordResponse<Ban> {
 ...
 */
suspend fun DiscordClient.createGuildBan(guildId: String, userId: String, payload: CreateBanPayload? = null): DiscordResponse<Unit> {
 ...
 */
suspend fun DiscordClient.removeGuildBan(guildId: String, userId: String): DiscordResponse<Unit> {
