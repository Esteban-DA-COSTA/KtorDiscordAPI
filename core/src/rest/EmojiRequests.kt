...
private fun DiscordClient.emojisUrl(guildId: Snowflake): String =
 ...
 */
suspend fun DiscordClient.listGuildEmojis(guildId: Snowflake): DiscordResponse<List<Emoji>> {
 ...
 */
suspend fun DiscordClient.getGuildEmoji(guildId: Snowflake, emojiId: Snowflake): DiscordResponse<Emoji> {
 ...
 */
suspend fun DiscordClient.createGuildEmoji(guildId: Snowflake, payload: CreateEmojiPayload): DiscordResponse<Emoji> {
 ...
 */
suspend fun DiscordClient.modifyGuildEmoji(guildId: Snowflake, emojiId: Snowflake, payload: ModifyEmojiPayload): DiscordResponse<Emoji> {
 ...
 */
suspend fun DiscordClient.deleteGuildEmoji(guildId: Snowflake, emojiId: Snowflake): DiscordResponse<Unit> {
